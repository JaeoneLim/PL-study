...
export const chapterGlossaries: Record<string, GlossaryEntry[]> = {
  "predicate-logic": [
    g(
      "predicate-logic", "Predicate Logic", "predicate logic",
    ...
    g(
      "carrier-set", "carrier set", "carrier set",
      ...
      "The set containing every possible value of one syntactic or semantic sort. In Chapter 1, `IntExp` and `Assert` are carrier sets for integer expressions and assertions.",
    ...
    g(
      "initial-algebra", "initial algebra", "initial algebra",
      ...
      "A structure containing exactly the finite syntax generated by its constructors, with no extra equalities. Once every constructor is interpreted in a target algebra, exactly one homomorphism to that target is determined.",
    ...
    g(
      "structural-induction", "structural induction", "structural induction",
    ...
    g(
      "capture-avoiding-substitution", "capture-avoiding substitution", "capture-avoiding substitution",
